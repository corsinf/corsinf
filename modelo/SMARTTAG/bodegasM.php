...
class bodegasM
{
	...
	{
		$sql = "SELECT id_bodegas,detalle_bodega as 'nombre' FROM bodegas WHERE 1 = 1 AND detalle_bodega = '".$nombre."'";
	...
	{
		$sql = "SELECT id_bodegas as 'id',detalle_bodega as 'nombre',produccion FROM bodegas WHERE 1 = 1 AND estado = 'A'";
		if($query)
		{
	...
	function lista_bodega_produccion($query)
	{
		$sql = "SELECT id_bodegas as 'id',detalle_bodega as 'nombre',produccion FROM bodegas WHERE 1 = 1 AND estado = 'A' AND produccion=1";
		if($query)
		{
			$sql.=" AND detalle_bodega LIKE '%".$query."%'";
		}
