	...
	function no_concurente_data()
	{
		...
		if ($tabla === '_talentoh.th_personas') {
			...
			$sql = "SELECT
						th_pos_id                AS id,
						th_pos_cedula            AS ci,
						th_pos_primer_nombre     AS nombre,
						th_pos_segundo_nombre    AS nombre2,
						th_pos_primer_apellido   AS apellido,
						th_pos_segundo_apellido  AS apellido2,
						th_pos_sexo              AS sexo,
						th_pos_fecha_nacimiento  AS fechaN,
						th_pos_correo            AS email,
						th_pos_telefono_1        AS telefono,
						th_pos_foto_url          AS foto,
						PERFIL                   AS usu,
						PASS                     AS pass,
