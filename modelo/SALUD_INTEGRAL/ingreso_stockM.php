		...
		$sql =
			"SELECT K.sa_kar_fecha as 'Fecha' ,
				...
				END AS 'Productos',
					...
					sa_kar_entrada as 'Entrada',
					sa_kar_salida as 'Salida',
					sa_kar_valor_unitario as 'Precio',
					sa_kar_existencias as 'Stock',
					sa_kar_serie as 'Serie',
					sa_kar_factura as 'Factura',
