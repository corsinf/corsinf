...
class fichas_EstudianteM
{
    ...
    {
        $sql = "SELECT sa_sec_id, sa_sec_nombre, sa_sec_estado FROM ficha_estudiante WHERE sa_sec_id = '" . $buscar . "'";
        $datos = $this->db_salud->datos($sql);
        return $datos;
    }
    ...
    {
        $sql = "UPDATE ficha_estudiante SET sa_sec_estado = 0 WHERE " . $datos[0]['campo'] . "='" . $datos[0]['dato'] . "';";
