...
class th_descansosM extends BaseModel
{
    protected $tabla = 'asis_descansos';
    protected $primaryKey = 'asi_descansos_id AS _id';
    ...
    function delete_descansos($id=false,$fecha="")
    {
        $table = "asis_descansos";
        if($fecha!=''){ $table = "asis_descansos_".$fecha; }
