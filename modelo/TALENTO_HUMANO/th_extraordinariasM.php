...
class th_extraordinariasM extends BaseModel
{
    protected $tabla = 'asis_extraordinarias';
    protected $primaryKey = 'asis_extraordinarias_id AS _id';
    ...
    protected $camposPermitidos = [
        ...
        'asis_extraordinarias_fecha_marcacion',
        'asis_extraordinarias_hora_marcacion',
        'asis_extraordinarias_total_min',
    ];

    function lista_descanso($persona,$tabla,$desde,$hasta)
    {
    ...
    function delete_extraordinarias($id=false,$fecha="")
    {
        $table = "asis_extraordinarias";
        if($fecha!=''){ $table = "asis_extraordinarias_".$fecha; }
