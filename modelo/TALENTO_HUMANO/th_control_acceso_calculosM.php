...
class th_control_acceso_calculosM extends BaseModel
{
   ...
   'th_asi_apellidos AS apellidos',
    ...
    'th_asi_turno_nombre AS turno',
    'th_asi_entrada_hora_inicio_turno AS hora_inicio_turno',
    'th_asi_entrada_hora_fin_turno AS hora_fin_turno',
    'th_asi_regentrada AS reg_entrada',
    ...
    'th_asi_salida_hora_inicio_turno AS hora_inicio_salida',
    'th_asi_salida_hora_fin_turno AS hora_fin_salida',
    'th_asi_regsalida AS reg_salida',
