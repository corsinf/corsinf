...
using CorsinfSDKHik.Controllers;
...
namespace CorsinfSDKHik.Funciones
{
    ...
    public class FuncionesConsola
    {
        ...
        public async Task funcionesAsync(string[] args)
        {
            var json = "";
            String r;
            if (args.Length > 0)
                ...
                switch (args[0])
                {
                    ...
                    case "6":
                        ...
                        if (m_UserId >= 0)
                        {
                            ...
                            {
                                FingerManagerSDK FingerMan = new FingerManagerSDK();
                                Task.Run(() => FingerMan.Escuchando(m_UserId, _conn, port));
                                ...
                                while (true)
                                {
                                 ...
                                 Console.WriteLine("Base no configurada");
                            }
                        }
                    ...
                    case "99":
                        ...
                        SqlConnection conn_ = empresa.ConexionEmpresa(IdEmpresa);
                        ...
                        {
                            dbModelo.InsertData(conn_, data);
                        }
