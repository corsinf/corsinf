...
com.logicpartners.labelControl.size = function (designer) {
	...
	this.NameContainer = $("<div>Nombre: </div>").addClass("designerLabelControlContainerName").appendTo(this.workspace);
	this.NameController = $("<input type=\"text\" id=\"txt_nom_etiqueta\" />")
	...
	this.heightController = $("<input type=\"text\"  id=\"txt_alto\"/>")
		.addClass("designerLabelControlElement")
		.css({
			width: "80px",
			height: "30px",
	...
	this.dpiController = $("<input id='txt_dpi' type=\"text\" />")
		.addClass("designerLabelControlElement")
		.css({
			width: "80px",
			height: "30px",
	...
	this.medidasController = $("<select  id=\"ddl_unidad\"></select>")
		.addClass("designerLabelControlElement")
		.css({
			width: "100px",
			height: "30px",
