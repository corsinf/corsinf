...
class carga_datos
{
	...
	function cargar_csv_masivo()
	{
	    ...
	    $sql = 'DELETE FROM ASSET;DELETE FROM PLANTILLA_MASIVA;DBCC CHECKIDENT (ASSET, RESEED, 0);DBCC CHECKIDENT (PLANTILLA_MASIVA, RESEED, 0);';
        ...
        if($BUKRS==''){break;}
				...
				if($PERNR!="")
				 ...
				 if($ORD42!="")
				 {
				 	...
				 	}if($ORD42=='' || !is_numeric($ORD42)){$ORD42= "''"; }		 
				 }else
				 {
				 	$ORD42= "''";
