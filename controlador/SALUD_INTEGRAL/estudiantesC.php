...
if (isset($_GET['listarEstconRepresentante'])) {
    echo json_encode($controlador->listaEstudianteRepresentante($_POST['id']));
}
...
class estudiantesC
{
    ...
    function listaEstudianteRepresentante($id)
    {
        $datos = $this->modelo->datosEstudianteRepresentante($id);
        return $datos;
    }
