<?php
require_once(dirname(__DIR__, 2) . '/modelo/RED_CONSULTORIOS/cat_t_consultasM.php');

$controlador = new cat_t_consultasC();
...
class cat_t_consultasC
{
    private $modelo;

    function __construct()
    {
        $this->modelo = new cat_t_consultasM();
    }

    function listar()
    {
        $datos = $this->modelo->where('t_con_estado', '1')->listar();
        return $datos;
    }
