    ...
    function insertar_editar($parametros)
{
    ...
    $datos = array(
        ...
        array('campo' => 'th_carasp_subordinacion', 'dato' =>  'Ninguno'),
        array('campo' => 'th_carasp_subordinacion_id', 'dato' => $subordinacion_id),
        array('campo' => 'th_carasp_supervision', 'dato' => 'Ninguno'),
        array('campo' => 'th_carasp_supervision_id', 'dato' => $supervision_id),
        array('campo' => 'th_carasp_comunicaciones_colaterales', 'dato' =>  'Ninguno'),
