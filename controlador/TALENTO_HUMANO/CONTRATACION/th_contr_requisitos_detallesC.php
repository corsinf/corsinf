...
require_once(dirname(__DIR__, 3)  . '/modelo/TALENTO_HUMANO/CONTRATACION/th_contr_requisitos_detallesM.php');

$controlador = new th_contr_requisitos_detallesC();
...
class th_contr_requisitos_detallesC
{
    private $modelo;

    function __construct()
    {
        $this->modelo = new th_contr_requisitos_detallesM();
    }
