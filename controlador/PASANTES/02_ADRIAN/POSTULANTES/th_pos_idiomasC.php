...
if (isset($_GET['listar'])) {
    echo json_encode($controlador->listar_idiomas($_POST['id']));
}
...
class th_pos_idiomasC
{
    ...
    function listar_idiomas()
    {
        ...
        foreach ($datos as $key => $value) {
            $option .= "<option id='ddl_opcion_" . $value['th_idi_id'] . "' value='" . $value['th_idi_id'] . "'>" . $value['th_idi_nombre_idioma'] . "</option>";
        }
        return $option;
    }

    function listar_nivel_idioma($id)
    {
        if ($id == '') {
