...
require_once(dirname(__DIR__, 3) . '/modelo/GENERAL/NO_CONCURRENTES/EMPLEADOSM.php');
require_once(dirname(__DIR__, 3) . '/modelo/TALENTO_HUMANO/th_personas_departamentosM.php');
