...
include('../controlador/proveedorC.php');?>
<script type="text/javascript">
  ...
  function clientes(query='')
  {
       $.ajax({
         data:  {query:query},
         url:   '../controlador/proveedorC.php?clientes=true',
         type:  'post',
         dataType: 'json',
         /*beforeSend: function () {   
    ...
    function clientes_inactivos(query='')
      {
       $.ajax({
         data:  {query:query},
         url:   '../controlador/proveedorC.php?clientes_inactivo=true',
         type:  'post',
         dataType: 'json',
         /*beforeSend: function () {   
              var spiner = '<div class="text-center"><img src="../../img/gif/proce.gif" width="100" height="100"></div>'     
  ...
  function new_usuario()
  {
    ...
    $.ajax({
         data:  datos,
         url:   '../controlador/proveedorC.php?new_usuario=true',
         type:  'post',
         dataType: 'json',
           success:  function (response) { 
            if (response==1) 
            {
               Swal.fire('','Nuevo proveeedor registrado.','success');
  ...
  function Editar(id)
  {
    ...
    $.ajax({
         data:  {id,id},
         url:   '../controlador/proveedorC.php?ficha_usuario=true',
         type:  'post',
         dataType: 'json',
           success:  function (response) { 
  ...
  function Eliminar(id)
  {
    ...
    $.ajax({
         data:  {id,id},
         url:   '../controlador/proveedorC.php?delete_usuario=true',
         type:  'post',
         dataType: 'json',
           success:  function (response) { 
            if(response==1)
    ...
    function inhabilitar_usuario(id)
   {
    $.ajax({
         data:  {id:id},
         url:   '../controlador/proveedorC.php?cliente_estado=true',
         type:  'post',
         dataType: 'json',
         /*beforeSend: function () {   
              var spiner = '<div class="text-center"><img src="../../img/gif/proce.gif" width="100" height="100"></div>'     
  ...
  function Activar(id)
   {
    $.ajax({
         data:  {id:id},
         url:   '../controlador/proveedorC.php?cliente_activar=true',
         type:  'post',
         dataType: 'json',
         /*beforeSend: function () {   
              var spiner = '<div class="text-center"><img src="../../img/gif/proce.gif" width="100" height="100"></div>'     
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-sm-6"><br>
            <b>Proveedor</b>
            <input type="text" name="txt_query" id="txt_query" class="form-control form-control-sm" placeholder="Buscar nombre Proveedor" onkeyup="search()">
          </div>
        </div>
        <div class="row">
            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item" onclick="$('#txt_tipo').val('C')"><a class="nav-link active" href="#clientes" data-toggle="tab">PROVEEDORES</a></li>
                  <li class="nav-item" onclick="$('#txt_tipo').val('P')"><a class="nav-link" href="#proveedores" data-toggle="tab"> PROVEEDORES INACTIVOS</a></li>
