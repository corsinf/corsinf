    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Persona Juridica</div>
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a></li>
                            <li class="breadcrumb-item active" aria-current="page">Formulario Persona Juridica</li>
                        </ol>
                    </nav>
                </div>
            </div>
            <div class="card border-top border-0 border-4 border-primary">
                <div class="card-body p-5">
                    ...
                    <form id="form_persona_juridica">
                        <label for="txt_razon_social">Razón Social:</label>
                        <input type="text" id="txt_razon_social" name="txt_razon_social">
                        <label for="txt_ruc">R.U.C.:</label>
                        <input type="text" id="txt_ruc" name="txt_ruc">
                        <label for="txt_nombre_completo">Nombres Completos del Representante Legal:</label>
                        <input type="text" id="txt_nombre_completo" name="txt_nombre_completo">
                        <label for="txt_cedula">Número de Cédula o Pasaporte:</label>
                        <input type="text" id="txt_cedula" name="txt_cedula">
                        <label for="txt_direccion_ruc">Dirección como está en el RUC:</label>
                        <input type="text" id="txt_direccion_ruc" name="txt_direccion_ruc">
