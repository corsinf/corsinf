                ...
                <div class="card-body">
                    <div class="border p-4 rounded">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-info">Formulario Persona Natural</h5>
                        </div>
                        <hr/>
                        <form>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="txt_nombre_completo" placeholder="Nombres Completos">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="txt_ruc" class="col-sm-4 col-form-label">Número de RUC</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="txt_ruc" placeholder="Número de RUC">
                                </div>
                            </div>
                            <div class="row mb-3">
