            ...
            <div class="col-xl-12 mx-auto">
                ...
                <?php if (
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 col-sm-6 col-md-4" id="pnl_pacientes" onclick="redireccionar('di_diseniador');">
                            <div class="card radius-10 shadow-card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div>
                                            <p class="mb-0 text-secondary">Diseñador</p>
                                            <h4 class="my-1" id="lbl_pacientes">0</h4>
                                        </div>
                                        <div class="widgets-icons bg-light-success text-success ms-auto"><i class='bx bx-printer'></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
