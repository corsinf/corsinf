                            ...
                            <div class="tab-content py-3">
                                <div class="tab-pane fade" id="departamentos" role="tabpanel">
                                    ...
                                    <form id="registrar_departamento" class="modal_general_provincias">
                                        ...
                                        <div class="d-flex justify-content-end pt-2">
                                            <?php if ($_id == '') { ?>
                                                <button class="btn btn-primary btn-sm px-4 m-0 d-flex align-items-center" onclick="insertar_persona_departamento();" type="button"><i class="bx bx-save"></i> Guardar</button>
                                            <?php } else { ?>
