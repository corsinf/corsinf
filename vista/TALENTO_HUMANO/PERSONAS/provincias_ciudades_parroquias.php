...
function cargar_datos_provincias() {
    ...
    if ($('#ddl_provincias').hasClass('select2-hidden-accessible')) {
        try { $('#ddl_provincias').select2('destroy'); } catch (e) { console.warn(e); }
    }

    $('#ddl_provincias').select2({
        language: {
            inputTooShort: function() { return "Por favor ingresa 0 o más caracteres"; },
            noResults: function() { return "No se encontraron resultados"; },
            searching: function() { return "Buscando..."; },
            errorLoading: function() { return "No se encontraron resultados"; }
        },
...
function cargar_datos_ciudades(th_prov_id) {
    ...
    if ($('#ddl_ciudad').hasClass('select2-hidden-accessible')) {
        try { $('#ddl_ciudad').select2('destroy'); } catch (e) { console.warn(e); }
    }
...
function cargar_datos_parroquias(th_ciu_id) {
    ...
    if ($('#ddl_parroquia').hasClass('select2-hidden-accessible')) {
        try { $('#ddl_parroquia').select2('destroy'); } catch (e) { console.warn(e); }
    }
