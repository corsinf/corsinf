...
<script type="text/javascript">
    ...
    function cargar_reporte(parametros) {
        ...
        let columns = [{
            ...
            {
                data: 'Entrada Inicio Turno',
                title: 'Entrada Inicio Turno'
            },
            {
                data: 'Entrada Fin Turno',
            ...
            {
                data: 'Salida Inicio Turno',
                title: 'Salida Inicio Turno'
            },
            {
                data: 'Salida Fin Turno',
            ...
            {
                data: 'Salidas Temprano',
                title: 'Salidas Temprano'
            },
            {
                data: 'Dias Trabajados',
                title: 'Días Trabajados'
            },
            {
                data: 'Cumplimiento de jornada (8 horas)',
                title: 'Cumplimiento Jornada (8h)'
            },
            {
                data: 'Horas faltantes por cumplir jornada',
                title: 'Horas Faltantes'
            },
            {
                data: 'Horas excedentes',
                title: 'Horas Excedentes'
            },
            {
                data: 'SalidasTemprano',
                        ...
                        <div class="">
                            <div class="card-body p-3">
                                ...
                                <div class="row g-3 mb-3">
                                    ...
                                    <!-- Panel fechas -->
                                    <div class="col-md-6" id="pnl_fechas">
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                <label for="txt_fecha_inicio" class="form-label fw-bold">
                                    ...
                                    <!-- Departamento -->
                                    <div class="col-md-3" id="select_departamento_container">
