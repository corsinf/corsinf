                            ...
                            <div class="row pt-3 mb-col align-items-center">
                                <div class="col-md-9">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="cbx_justificar_rango"
                                            name="cbx_justificar_rango" value="1">
                                        <label class="form-check-label" for="cbx_justificar_rango">Justificar, por
                                            rangos</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row pt-3 mb-col">
                                <div class="col-md-3">
                                    ...
                                    <input type="datetime-local" class="form-control form-control-sm"
                                        id="txt_fecha_inicio" name="txt_fecha_inicio" maxlength="50">
                                </div>
                                <div class="col-md-3">
                                    <label for="txt_fecha_fin" class="form-label">Fecha Final </label>
                                    <input type="datetime-local" class="form-control form-control-sm" id="txt_fecha_fin"
