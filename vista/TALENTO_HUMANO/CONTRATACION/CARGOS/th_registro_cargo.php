                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="txt_th_car_nombre"
                                                name="txt_th_car_nombre" placeholder="Ingrese el nombre del cargo"
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" class="form-control" id="txt_th_car_nivel"
                                                name="txt_th_car_nivel" placeholder="Ej: Junior, Senior" />
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" class="form-control" id="txt_th_car_area"
                                                name="txt_th_car_area" placeholder="Ej: Administrativa" />
                                        </div>
