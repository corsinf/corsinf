                ...
                if (res == 1) {
                    Swal.fire('', 'Asignación creada con éxito.', 'success').then(function() {
                        window.location.href =
                            '../vista/inicio.php?mod=<?= $modulo_sistema ?>&acc=th_contr_plaza_cargo';
                    });
                } else if (res == -2) {
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res == 1) {
                    ...
                    Swal.fire('', 'Ya existe otra asignación activa para esa Plaza y Cargo.',
                        'warning');
                } else {
                    ...
                    <div class="card-body p-4">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-primary">
                                <?= ($_id == '') ? 'Nueva Asignación' : 'Modificar Asignación' ?></h5>
                            <div class="ms-auto">
                                <a href="../vista/inicio.php?mod=<?= $modulo_sistema ?>&acc=th_contr_plaza_cargo"
                        ...
                        <form id="form_plaza_cargo">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select select2-validation" id="ddl_plaza" name="ddl_plaza"
                                        required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" min="1" class="form-control" id="txt_th_pc_cantidad"
                                        name="txt_th_pc_cantidad" placeholder="Ej: 1" required />
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="0.01" class="form-control"
                                            id="txt_th_pc_salario_ofertado" name="txt_th_pc_salario_ofertado"
                                            placeholder="0.00" />
                                    </div>
                                </div>
                                ...
                                <div class="mt-4 text-end">
                                    <?php if ($_id == '') { ?>
                                    <button type="button" class="btn btn-success" id="btn_guardar_pc"><i
                                            class="bx bx-save me-1"></i> Guardar Asignación</button>
                                    <?php } else { ?>
                                    <button type="button" class="btn btn-primary" id="btn_editar_pc"><i
                                            class="bx bx-edit me-1"></i> Actualizar</button>
                                    <button type="button" class="btn btn-danger" id="btn_eliminar_pc"><i
