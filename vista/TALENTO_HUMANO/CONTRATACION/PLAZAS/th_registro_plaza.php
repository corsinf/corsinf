            ...
            success: function(res) {
                if (res == 1) {
                    ...
                    if ($('#error_txt_th_pla_titulo').length == 0) {
                        $('#txt_th_pla_titulo').after(
                            '<div id="error_txt_th_pla_titulo" class="invalid-feedback">El título de la plaza ya está en uso.</div>'
                        );
                    } else {
                        $('#error_txt_th_pla_titulo').text('El título de la plaza ya está en uso.');
                    }
                } else {
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res == 1) {
                    ...
                    if ($('#error_txt_th_pla_titulo').length == 0) {
                        $('#txt_th_pla_titulo').after(
                            '<div id="error_txt_th_pla_titulo" class="invalid-feedback">El título de la plaza ya está en uso por otro registro.</div>'
                        );
                    } else {
                        $('#error_txt_th_pla_titulo').text(
                            'El título de la plaza ya está en uso por otro registro.');
                    }
                } else {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    success: function(res) {
                        if (res == 1) {
                            Swal.fire('Eliminado!', 'Plaza eliminada.', 'success').then(
                                function() {
                                    window.location.href =
                                        '../vista/inicio.php?mod=<?= $modulo_sistema ?>&acc=th_contr_plazas';
                                });
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control" id="txt_th_pla_titulo"
                                                name="txt_th_pla_titulo" placeholder="Ingrese el título de la plaza"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-select select2-validation" id="ddl_th_pla_tipo"
                                                name="ddl_th_pla_tipo" required>
                                                <option value="" selected hidden>-- Seleccione --</option>
                                                <option value="Interna">Interna</option>
                                                <option value="Externa">Externa</option>
                                                <option value="Mixta">Mixta</option>
                                            </select>
                                            <div class="form-text">Seleccione si la plaza es interna, externa o mixta
                                            </div>
                                        </div>
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="datetime-local" class="form-control"
                                                        ...
                                                        name="txt_th_pla_fecha_publicacion" />
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <label for="txt_th_pla_tiempo_contrato" class="form-label fw-bold">
                                                        <i class="bx bx-time-five me-2 text-primary"></i> Duración del
                                                        Contrato
                                                    </label>
                                                    <input type="text" class="form-control"
                                                        id="txt_th_pla_tiempo_contrato"
                                                        name="txt_th_pla_tiempo_contrato"
                                                        placeholder="Ej: Indefinido, 6 meses, 1 año" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-12">
                                                    <label class="form-label fw-bold d-block">
                                                        <i class="bx bx-check-shield me-2 text-primary"></i> Prioridad
                                                        Interna
                                                    </label>
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-12">
                                                    <label for="txt_th_pla_observaciones" class="form-label fw-bold">
                                                        <i class="bx bx-comment-detail me-2 text-warning"></i>
                                                        Observaciones
                                                    </label>
                                                    <textarea class="form-control" id="txt_th_pla_observaciones"
                                                        name="txt_th_pla_observaciones"
