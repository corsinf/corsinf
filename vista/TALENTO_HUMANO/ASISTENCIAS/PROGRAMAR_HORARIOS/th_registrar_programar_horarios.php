        ...
        success: function(response) {
            if (response == 1) {
                Swal.fire('', 'Operacion realizada con exito.', 'success').then(function() {
                    location.href =
                        '../vista/inicio.php?mod=<?= $modulo_sistema ?>&acc=th_programar_horarios';
                });
            } else if (response == -2) {
                ...
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <div class="row m-2">
                                <div class="col-sm-12">
                                    <a href="../vista/inicio.php?mod=<?= $modulo_sistema ?>&acc=th_programar_horarios"
                        ...
                        <form id="form_programar_horarios">
                            ...
                            <div class="mb-col mt-2">
                                ...
                                <input type="text" id="txt_tipo_programar" class="form-control" readonly
                                    value="<?= ucfirst($tipo) ?>">
                            </div>
                            ...
                            <div class="mb-col pt-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="cbx_horario" id="cbx_horario_con"
                                        value="1">
                                ...
                                <div id="pnl_horarios" style="display: none;">
                                    <div class="row mb-col">
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select form-select-sm select2-validation"
                                                id="ddl_horarios" name="ddl_horarios">
                                                <option selected disabled>-- Seleccione --</option>
                                            </select>
                                    ...
                                    <div class="form-check ms-4">
                                        <input class="form-check-input" type="radio" name="cbx_horario_detalle"
                                            id="cbx_horario_detalle_1" value="1">
                                        <label class="form-check-label" for="cbx_horario_detalle_1">Tomar en cuenta los
                                            intervalos </label>
                                    </div>
                                    <div class="form-check ms-4">
                                        <input class="form-check-input" type="radio" name="cbx_horario_detalle"
                                            id="cbx_horario_detalle_2" value="2">
                                        <label class="form-check-label" for="cbx_horario_detalle_2">Sin tomar en cuenta
                                            los intervalos </label>
                                    </div>
                                </div>

                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="cbx_horario" id="cbx_horario_sin"
                                        value="2">
                            ...
                            <div class="row pt-3 mb-col">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="date" class="form-control form-control-sm" id="txt_fecha_inicio"
                                        name="txt_fecha_inicio" maxlength="50">
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="date" class="form-control form-control-sm" id="txt_fecha_fin"
                                        name="txt_fecha_fin" maxlength="50">
                                </div>
                            </div>
