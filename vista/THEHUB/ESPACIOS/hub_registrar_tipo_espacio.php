...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function cargar_espacio(id_espacio) {
            $.ajax({
                data: {
                    id: id_espacio
                },
                url: '../controlador/XPACE_CUBE/tipo_espacioC.php?listar=true',
                type: 'post',
                dataType: 'json',
                ...
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <div class="row m-2">
                                <div class="col-sm-12">
                                    <a href="../vista/inicio.php?mod=<?= $modulo_sistema ?>&acc=hub_tipo_espacio" class="btn btn-outline-dark btn-sm"><i class="bx bx-arrow-back"></i> Regresar</a>
                                </div>
                            </div>
                        </div>
                        <hr>
