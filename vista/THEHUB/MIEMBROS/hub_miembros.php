...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        tbl_miembros = $('#tbl_miembros').DataTable($.extend({}, configuracion_datatable('Nombre', 'direccion', 'telefono'), {
            reponsive: true,
            language: {
                url: '../assets/plugins/datatable/spanish.json'
            },
            ajax: {
                url: '../controlador/XPACE_CUBE/miembrosC.php?listar=true',
                dataSrc: ''
            },
            columns: [{
                    data: null,
                    render: function(data, type, item) {
                        href = `../vista/inicio.php?mod=<?= $modulo_sistema ?>&acc=miembros_update&_id=${item._id}`;
                        return `<a href="${href}"><u>${item.nombre} ${item.apellido}</u></a>`;
                    }
                },
                {
                    data: 'direccion'
                        ...
                        <section class="content pt-2">
                            <div class="container-fluid">
                                <div class="table-responsive">
                                    <table class="table table-striped responsive " id="tbl_miembros" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>Nombre</th>
                                                <th>Dirección</th>
