        ...
        tbl_movimientos_bodega = $('#tbl_movimientos_bodega').DataTable($.extend({}, configuracion_datatable('Nombre', 'cuidad', 'telefono'), {
            ...
            columns: [{
                    ...
                    render: function(data, type, item) {
                        href = `../vista/inicio.php?mod=<?= $modulo_sistema ?>&acc=hub_registrar_movimiento_articulo&_id=${item._id}`;
                        return `<a href="${href}"><u>${item.nombre_articulo}</u></a>`;
                    }
                },
                {
                    data: 'nombre_reserva'
                        ...
                        <div class="card-title d-flex align-items-center">
                            ...
                            <div class="row mx-0">
                                ...
                                <div class="" id="btn_nuevo">
                                    <a href="../vista/inicio.php?mod=<?= $modulo_sistema ?>&acc=hub_registrar_movimiento_articulo"
                        ...
                        <section class="content pt-2">
                            <div class="container-fluid">
                                <div class="table-responsive">
                                    <table class="table table-striped responsive " id="tbl_movimientos_bodega" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>Articulo</th>
                                                <th>Reserva</th>
