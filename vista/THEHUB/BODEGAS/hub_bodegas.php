...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        tbl_articulos_bodega = $('#tbl_articulos_bodega').DataTable($.extend({}, configuracion_datatable('codigo', 'nombre', 'descripcion','categoria'), {
            reponsive: true,
            language: {
            ...
            columns: [{
                    ...
                    render: function(data, type, item) {
                        href = `../vista/inicio.php?mod=<?= $modulo_sistema ?>&acc=hub_registrar_bodega&_id=${item._id}`;
                ...
                },
                {
                 ...
                 {
                   render: function(data, type, item) {
                        return `${item.cantidad_disponible} / ${item.cantidad_total}`;
                    }
                },
            ],
            order: [
                        ...
                        <div class="card-title d-flex align-items-center">
                            ...
                            <div class="row mx-0">
                                ...
                                <div class="" id="btn_nuevo">
                                    <a href="../vista/inicio.php?mod=<?= $modulo_sistema ?>&acc=hub_registrar_bodega"
                        ...
                        <section class="content pt-2">
                            <div class="container-fluid">
                                <div class="table-responsive">
                                    <table class="table table-striped responsive " id="tbl_articulos_bodega" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>Codigo</th>
                                                <th>Nombre</th>
                                                <th>Descripción</th>
                                                <th>Categoria</th>
                                                <th>Cantidad Total / Cantidad Disponible</th>
                                            </tr>
                                        </thead>
                                        <tbody class="">
