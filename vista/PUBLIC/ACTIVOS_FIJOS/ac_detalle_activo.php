...
<script src="vista/public/activos_fijos/ac_detalle_activo.js?v=<?= rand() ?>"></script>
        ...
        <div class="mobile-content">
            ...
            <div class="identifiers-container">
                <div class="identifiers-grid">
                    ...
                    <div class="identifier-card">
                        <div class="identifier-value" id="lbl_estado">-</div>
                        <div class="identifier-label">Estado</div>
                    </div>
                    <div class="identifier-card">
                        <div class="identifier-value" id="lbl_genero">-</div>
                        <div class="identifier-label">Etiqueta</div>
                    </div>
                </div>
            </div>
