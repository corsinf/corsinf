             ...
             <b> Busqueda por custodio</b>
               <div class="input-group input-group-sm">
                <select class="form-control form-control-sm" id="ddl_custodio" onchange="$('#txt_pag').val('0-25');lista_articulos()" style="width:80%"></select>
                    <button type="button" class="btn btn-secondary btn-flat btn-sm" onclick="limpiar('ddl_custodio')" title="Limpiar custodio"><i class="bx bx-x"></i></button>
             ...
             <div class="col-sm-4">
               ...
               <div class="input-group input-group-sm">
                <select class="form-control form-control-sm" id="ddl_localizacion" onchange="$('#txt_pag').val('0-25');lista_articulos()" style="width:80%"></select>
                    <button type="button" class="btn btn-secondary btn-flat btn-sm" onclick="limpiar('ddl_localizacion')" title="Limpiar localizacion"><i class="bx bx-x"></i></button>
                </div>
             </div>    
            </div>
