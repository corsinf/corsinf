...
function informes()
{
   ...
   $.ajax({
      // data:  {id:id},
      url:  '../controlador/reportesC.php?informes_terceros=true',
      type:  'post',
      dataType: 'json',
      /*beforeSend: function () {   
 ...
 function autocmpletar(){
    ...
    function lista_articulos()
  {
    ...
    $.ajax({
      ...
      url:   '../controlador/tercerosC.php?lista=true',
      type:  'post',
      dataType: 'json',
      beforeSend: function () {   
           // var spiner = '<div class="text-center"><img src="../img/gif/proce.gif" width="100" height="100"></div>'     
  ...
  function buscar_art()
  {
    $.ajax({
      // data:  {id:id},
      url:  '../controlador/tercerosC.php?tipo_view=true',
      type:  'post',
      dataType: 'json',      
        success:  function (response) {
           if(response==1)
...
{   
  ...
  var url =  '../controlador/tercerosC.php?ver_pdf=true&'+filtros+'&informe='+id+'&pag='+$('#txt_pag').val();                 
  window.open(url, '_blank');
}
function ver_informe_excel(id)
{   
  var filtros = $('#pnl_filtros').serialize();
  var url =  '../controlador/tercerosC.php?ver_excel=true&'+filtros+'&informe='+id+'&pag='+$('#txt_pag').val();                 
  window.open(url, '_blank');
}
