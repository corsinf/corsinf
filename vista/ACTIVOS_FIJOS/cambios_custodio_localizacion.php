...
<script type="text/javascript">
  ...
  function lista_articulos() {
    ...
    $.ajax({
      ...
      url: '../controlador/ACTIVOS_FIJOS/cambios_custodio_localizacionC.php?lista=true',
      type: 'post',
      dataType: 'json',
      beforeSend: function() {
  ...
  function cambiar() {
    ...
    $.ajax({
      ...
      url: '../controlador/ACTIVOS_FIJOS/cambios_custodio_localizacionC.php?cambiar=true',
      type: 'post',
      dataType: 'json',
      success: function(response) {
        // console.log(response);
        if (response == 1) {
          Swal.fire('Se transfirieron los articulos', '', 'success').then(function() {
            location.reload();
          });
        }
      }
          ...
          <div class="card-body">
            ...
            <div class="row" id="custodio">
              ...
              <div class="col-sm-4">
                ...
                <div class="input-group input-group-sm">
                  <select class="form-control form-control-sm" id="ddl_custodio" onchange="$('#txt_pag').val('0-25');lista_articulos()" style="width:100%">
              ...
              <div class="col-sm-4">
                <b> Nuevo custodio</b>
                <div class="input-group input-group-sm">
                  <select class="form-control form-control-sm" id="ddl_custodio2" onchange="$('#txt_pag').val('0-25');lista_articulos()" style="width:100%">
                    <option value="">Seleccione un Custodio</option>
                  </select>
                </div>
              </div>
            ...
            <div class="row" id="localizacion" style="display: none;">
              ...
              <div class="col-sm-4">
                ...
                <div class="input-group input-group-sm">
                  <select class="form-control form-control-sm" id="ddl_localizacion" onchange="$('#txt_pag').val('0-25');lista_articulos()" style="width:100%">
              ...
              <div class="col-sm-4">
                ...
                <div class="input-group input-group-sm">
                  <select class="form-control form-control-sm" id="ddl_localizacion2" onchange="$('#txt_pag').val('0-25');lista_articulos()" style="width:100%">
                    <option value="">Seleccione Una localizacion</option>
                  </select>
