...
<script type="text/javascript">
  ...
  function informes() {
    ...
    $.ajax({
      // data:  {id:id},
      url: '../controlador/ACTIVOS_FIJOS/reportesC.php?informes_baja=true',
      type: 'post',
      dataType: 'json',
      /*beforeSend: function () {   
  ...
  function lista_articulos() {
    ...
    $.ajax({
      ...
      url: '../controlador/ACTIVOS_FIJOS/bajasC.php?lista=true',
      type: 'post',
      dataType: 'json',
      beforeSend: function() {
        // var spiner = '<div class="text-center"><img src="../img/gif/proce.gif" width="100" height="100"></div>'     
      ...
      success: function(response) {
        ...
        $.each(response.datos, function(i, item) {
          baja = '';
          if (item.BAJAS == 1) {
            baja = 'background-color: #f95F4933;'
          }
        ...
        if (lineas == '') {
          lineas = '<tr><td colspan="13">Sin Registros</td></tr>';
        }
  ...
  function buscar_art() {
    $.ajax({
      // data:  {id:id},
      url: '../controlador/ACTIVOS_FIJOS/bajasC.php?tipo_view=true',
      type: 'post',
      dataType: 'json',
      success: function(response) {
        if (response == 1) {
  ...
  function ddl_meses() {
    ...
    $.ajax({
      // data:  {id:id},
      url: '../controlador/ACTIVOS_FIJOS/articulosC.php?meses=true',
      type: 'post',
      dataType: 'json',
      /*beforeSend: function () {   
           var spiner = '<div class="text-center"><img src="../img/gif/proce.gif" width="100" height="100"></div>'     
  ...
  function ver_informe_pdf(id) {
    ...
    var url = '../controlador/ACTIVOS_FIJOS/bajasC.php?ver_pdf=true&' + filtros + '&informe=' + id + '&pag=' + $('#txt_pag').val();
    window.open(url, '_blank');
  }

  function ver_informe_excel(id) {
    var filtros = $('#pnl_filtros').serialize();
    var url = '../controlador/ACTIVOS_FIJOS/bajasC.php?ver_excel=true&' + filtros + '&informe=' + id + '&pag=' + $('#txt_pag').val();
    window.open(url, '_blank');
  }
