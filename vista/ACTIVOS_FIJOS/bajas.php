...
//include('../cabeceras/header.php');
  $tipo_lista = 1;
  if(isset($_SESSION['INICIO']["LISTA_ART"])){$tipo_lista = $_SESSION['INICIO']["LISTA_ART"]; }else{ $_SESSION['INICIO']["LISTA_ART"]=1;} 
?>
...
function informes()
{
   ...
   $.ajax({
      // data:  {id:id},
      url:  '../controlador/reportesC.php?informes_baja=true',
      type:  'post',
      dataType: 'json',
      /*beforeSend: function () {   
 ...
 function autocmpletar(){
    ...
    function lista_articulos()
  {
    ...
    $.ajax({
      ...
      url:   '../controlador/bajasC.php?lista=true',
      type:  'post',
      dataType: 'json',
      beforeSend: function () {   
           // var spiner = '<div class="text-center"><img src="../img/gif/proce.gif" width="100" height="100"></div>'     
        ...
        $.each(response.datos, function(i, item){
          baja = '';
          if(item.BAJAS==1){baja = 'background-color: #f95F4933;'}
        ...
        if(lineas==''){lineas = '<tr><td colspan="13">Sin Registros</td></tr>';}       
  ...
  function buscar_art()
  {
    $.ajax({
      // data:  {id:id},
      url:  '../controlador/bajasC.php?tipo_view=true',
      type:  'post',
      dataType: 'json',      
        success:  function (response) {
           if(response==1)
...
{   
  ...
  var url =  '../controlador/bajasC.php?ver_pdf=true&'+filtros+'&informe='+id+'&pag='+$('#txt_pag').val();                 
  window.open(url, '_blank');
}
function ver_informe_excel(id)
{   
  var filtros = $('#pnl_filtros').serialize();
  var url =  '../controlador/bajasC.php?ver_excel=true&'+filtros+'&informe='+id+'&pag='+$('#txt_pag').val();                 
  window.open(url, '_blank');
}
...
<div class="page-wrapper">
      <div class="page-content">
        ...
        <!-- <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
          <div class="breadcrumb-title pe-3">ACTIVOS FIJOS</div>
          <div class="ps-3">
              ...
              <div class="card-body">
                ...
                <div class="row">                      
                   ...
                   <div class="col-sm-4">
                    <b>Custodio</b>
                    <div class="input-group">                 
                      <select class="form-select" name="ddl_custodio" id="ddl_custodio"  onchange="$('#txt_pag').val('0-25');buscar_art();/*lista_articulos()*/">
                ...
                <div class="row" id="mas_filtros" style="display: none;">
                  ...
                  <div class="col-sm-2 border-end">
                    ...
                    <div class="col-sm-4">
                        ...
                        <p class="font-10">Fecha de baja</p>
                    </div>
                    <div class="col-sm-12 text-end">
                ...
                <div class="row">
                  <div class="col-sm-6 col-md-8">
                    <label style="background-color:#f95F49"> Bajas </label>     
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-5 product-grid mb-0" id="grilla_art" style="display: none;">
