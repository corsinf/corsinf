...
<script type="text/javascript">
  ...
  function lista_articulos() {
    ...
    $.ajax({
      ...
      url: '../controlador/ACTIVOS_FIJOS/actasC.php?lista=true',
      type: 'post',
      dataType: 'json',
      beforeSend: function() {
  ...
  function autocmpletar_lo_masivo() {
    ...
    $('#ddl_localizacion_masivo').select2({
      ...
      width: '100%',
      ajax: {
        url: '../controlador/ACTIVOS_FIJOS/localizacionC.php?lista=true&custodio=' + cus + '&masivo=' + $('#txt_masivo_cus').val(),
        dataType: 'json',
        delay: 250,
        processResults: function(data) {
          return {
  ...
  function pasar_lista(id) {
    ...
    $.ajax({
      ...
      url: '../controlador/ACTIVOS_FIJOS/actasC.php?addacta=true',
      type: 'post',
      dataType: 'json',
      success: function(response) {
        console.log(response);
  ...
  function eliminar_lista(id) {
    ...
    $.ajax({
      ...
      url: '../controlador/ACTIVOS_FIJOS/actasC.php?eliminar_lista=true',
      type: 'post',
      dataType: 'json',
      success: function(response) {
        if (response == 1) {
  ...
  function lista_actas() {
    ...
    $.ajax({
      ...
      url: '../controlador/ACTIVOS_FIJOS/actasC.php?lista_actas=true',
      type: 'post',
      dataType: 'json',
      success: function(response) {
        console.log(response);
  ...
  function pasar_selected() {
    ...
    $.ajax({
      data: datos,
      url: '../controlador/ACTIVOS_FIJOS/actasC.php?add_selected=true',
      type: 'post',
      dataType: 'json',
      success: function(response) {
        lista_articulos();
  ...
  function pasar_todo() {
    ...
    $.ajax({
      ...
      url: '../controlador/ACTIVOS_FIJOS/actasC.php?add_masivo=true',
      type: 'post',
      dataType: 'json',
      success: function(response) {
        lista_actas();
  ...
  function eliminar_todo() {
    ...
    $.ajax({
      // data:  {parametros:parametros},
      url: '../controlador/ACTIVOS_FIJOS/actasC.php?delete_masivo=true',
      type: 'post',
      dataType: 'json',
      success: function(response) {
        lista_actas();
  ...
  function dar_baja_() {
    ...
    $.ajax({
      ...
      url: '../controlador/ACTIVOS_FIJOS/actasC.php?dar_baja=true',
      type: 'post',
      dataType: 'json',
      success: function(response) {
        if (response == 1) {
  ...
  function cambiar_custodio() {
    ...
    $.ajax({
      ...
      url: '../controlador/ACTIVOS_FIJOS/actasC.php?cambiar_custodio=true',
      type: 'post',
      dataType: 'json',
      success: function(response) {
        if (response == 1) {
  ...
  function cambiar_entrada_salida() {
    ...
    $.ajax({
      ...
      url: '../controlador/ACTIVOS_FIJOS/actasC.php?cambiar_E_S=true',
      type: 'post',
      dataType: 'json',
      success: function(response) {
        if (response == 1) {
...
<script type="text/javascript">
  ...
  function validar_codigos_custodios() {
    ...
    $.ajax({
      ...
      url: '../controlador/ACTIVOS_FIJOS/custodioC.php?custodios_masivos=true',
      type: 'post',
      dataType: 'json',
      success: function(response) {
        console.log(response);
  ...
  function validar_codigos_localizacion() {
    ...
    $.ajax({
      ...
      url: '../controlador/ACTIVOS_FIJOS/localizacionC.php?localizacion_masivos=true',
      type: 'post',
      dataType: 'json',
      success: function(response) {
        console.log(response);
