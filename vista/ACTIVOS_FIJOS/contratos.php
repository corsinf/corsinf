...
<script type="text/javascript">
  ...
  function forma_pago() {
    $.ajax({
      ...
      url: '../controlador/ACTIVOS_FIJOS/contratoC.php?forma_pago=true',
      type: 'post',
      dataType: 'json',
  ...
  function lista_cobertura() {
    $('#ddl_cobertura').select2({
      ...
      width: '85%',
      ajax: {
        url: '../controlador/ACTIVOS_FIJOS/contratoC.php?lista_cobertura=true',
        dataType: 'json',
        delay: 250,
  ...
  function lista_siniestros() {
    ...
    $('#ddl_siniestros').select2({
      ...
      width: '80%',
      ajax: {
        url: '../controlador/ACTIVOS_FIJOS/contratoC.php?lista_siniestros=true&cob=' + cob,
        dataType: 'json',
        delay: 250,
        processResults: function(data) {
          // console.log(data);
  ...
  function lista_proveedor() {
    $('#ddl_proveedor').select2({
      ...
      width: '87%',
      ajax: {
        url: '../controlador/ACTIVOS_FIJOS/contratoC.php?lista_proveedores=true',
        dataType: 'json',
        delay: 250,
        processResults: function(data) {
          // console.log(data);
  ...
  function lista_articulos() {
    ...
    $('#ddl_articulos').select2({
      ...
      width: '100%',
      ajax: {
        url: '../controlador/ACTIVOS_FIJOS/contratoC.php?lista_articulos=true&tabla=' + tabla,
        dataType: 'json',
        delay: 250,
        processResults: function(data) {
          // console.log(data);
  ...
  function guardar_contrato() {
    ...
    $.ajax({
      ...
      url: '../controlador/ACTIVOS_FIJOS/contratoC.php?seguroSave=true',
      type: 'post',
      dataType: 'json',
      /*beforeSend: function () {   
  ...
  function cobertura() {
    ...
    $.ajax({
      ...
      url: '../controlador/ACTIVOS_FIJOS/contratoC.php?coberturaSave=true',
      type: 'post',
      dataType: 'json',
      /*beforeSend: function () {   
           var spiner = '<div class="text-center"><img src="../img/gif/proce.gif" width="100" height="100"></div>'     
  ...
  function tipo_pago_save() {
    ...
    $.ajax({
      ...
      url: '../controlador/ACTIVOS_FIJOS/contratoC.php?tipo_pago_save=true',
      type: 'post',
      dataType: 'json',
      /*beforeSend: function () {   
           var spiner = '<div class="text-center"><img src="../img/gif/proce.gif" width="100" height="100"></div>'     
  ...
  function cargar_datos_seguro(id) {
    ...
    $.ajax({
      ...
      url: '../controlador/ACTIVOS_FIJOS/contratoC.php?cargar_datos_seguro=true',
      type: 'post',
      dataType: 'json',
      success: function(response) {
  ...
  function siniestros() {
    ...
    $.ajax({
      ...
      url: '../controlador/ACTIVOS_FIJOS/contratoC.php?siniestroSave=true',
      type: 'post',
      dataType: 'json',
      success: function(response) {
        if (response == 1) {
  ...
  function editar_insertar() {
    ...
    $.ajax({
      ...
      url: '../controlador/ACTIVOS_FIJOS/contratoC.php?proveSave=true',
      type: 'post',
      dataType: 'json',
      success: function(response) {
        if (response == 1) {
  ...
  function agregar_a_contrato() {
    ...
    $.ajax({
      ...
      url: '../controlador/ACTIVOS_FIJOS/contratoC.php?Articulo_contrato_Save=true',
      type: 'post',
      dataType: 'json',
      success: function(response) {
        if (response == 1) {
  ...
  function Articulo_contrato_lista() {
    ...
    $.ajax({
      ...
      url: '../controlador/ACTIVOS_FIJOS/contratoC.php?Articulo_contrato_lista=true',
      type: 'post',
      dataType: 'json',
      success: function(response) {
        if (response != '') {
  ...
  function eliminar(id) {
    $.ajax({
      ...
      url: '../controlador/ACTIVOS_FIJOS/contratoC.php?Articulo_contrato_delete=true',
      type: 'post',
      dataType: 'json',
      success: function(response) {
        if (response == 1) {
