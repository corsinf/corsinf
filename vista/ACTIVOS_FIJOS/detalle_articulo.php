...
<script type="text/javascript">
  $(document).ready(function() {
    cargarAvaluo(<?php if (isset($_GET['id'])) {
                    echo $_GET['id'];
                  } ?>);
    // navegacion();
...
<script type="text/javascript">
  ...
  function autocmpletar_fam() {
    $('#ddl_familia').select2({
      ...
      ajax: {
        url: '../controlador/ACTIVOS_FIJOS/familiasC.php?lista_drop=true',
        dataType: 'json',
        delay: 250,
        processResults: function(data) {
          return {
  ...
  function autocmpletar_clase_mov() {
    $('#ddl_clase_mov').select2({
      placeholder: 'Seleccione una familia',
      ajax: {
        url: '../controlador/ACTIVOS_FIJOS/clase_movimientoC.php?buscar_auto=true',
        dataType: 'json',
        delay: 250,
        processResults: function(data) {
          return {
  ...
  function autocmpletar_subfam() {
    ...
    $('#ddl_subfamilia').select2({
      ...
      ajax: {
        url: '../controlador/ACTIVOS_FIJOS/familiasC.php?lista_subfamilia=true&fam=' + fa,
        dataType: 'json',
        delay: 250,
        processResults: function(data) {
          return {
  ...
  function autocmpletar_color() {
    $('#ddl_color').select2({
      ...
      ajax: {
        url: '../controlador/ACTIVOS_FIJOS/detalle_articuloC.php?colores=true',
        dataType: 'json',
        delay: 250,
        processResults: function(data) {
          return {
  ...
  function autocmpletar_marca() {
    $('#ddl_marca').select2({
      ...
      ajax: {
        url: '../controlador/ACTIVOS_FIJOS/detalle_articuloC.php?marca=true',
        dataType: 'json',
        delay: 250,
        processResults: function(data) {
          return {
  ...
  function autocmpletar_genero() {
    $('#ddl_genero').select2({
      placeholder: 'Seleccione una custodio',
      ajax: {
        url: '../controlador/ACTIVOS_FIJOS/detalle_articuloC.php?genero=true',
        dataType: 'json',
        delay: 250,
        processResults: function(data) {
          return {
  ...
  function autocmpletar_estado() {
    $('#ddl_estado').select2({
      ...
      ajax: {
        url: '../controlador/ACTIVOS_FIJOS/estadoC.php?lista_drop=true',
        dataType: 'json',
        delay: 250,
        processResults: function(data) {
          return {
  ...
  function autocmpletar_proyecto() {
    $('#ddl_proyecto').select2({
      ...
      ajax: {
        url: '../controlador/ACTIVOS_FIJOS/detalle_articuloC.php?proyecto=true',
        dataType: 'json',
        delay: 250,
        processResults: function(data) {
          return {
    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        $('#ddl_localizacion').append($('<option>', {
          value: response[0].id_loc,
          text: response[0].DENOMINACION,
          selected: true
        }));
        $('#ddl_custodio').append($('<option>', {
          value: response[0].id_cus,
          text: response[0].PERSON_NOM,
          selected: true
        }));
        $('#ddl_marca').append($('<option>', {
          value: response[0].mar,
          text: response[0].marca,
          selected: true
        }));
        $('#ddl_color').append($('<option>', {
          value: response[0].col,
          text: response[0].color,
          selected: true
        }));
        $('#ddl_genero').append($('<option>', {
          value: response[0].gen,
          text: response[0].genero,
          selected: true
        }));
        $('#ddl_proyecto').append($('<option>', {
          value: response[0].idpro,
          text: response[0].proyecto,
          selected: true
        }));
        $('#ddl_estado').append($('<option>', {
          value: response[0].est,
          text: response[0].estado,
          selected: true
        }));


        $('#ddl_familia').append($('<option>', {
          value: response[0].IDF,
          text: response[0].FAMILIA,
          selected: true
        }));
        $('#ddl_subfamilia').append($('<option>', {
          value: response[0].IDSUBF,
          text: response[0].SUBFAMILIA,
          selected: true
        }));
        $('#ddl_clase_mov').append($('<option>', {
          value: response[0].CLASE_MOVIMIENTO,
          text: response[0].MOVIMIENTO,
          selected: true
        }));
        ...
        $('#txt_fecha').val(formatoDate(response[0].fecha));
        ...
        $('#txt_compra').val(formatoDate(response[0].ORIG_ACQ_YR));
  ...
  function datos_col(id) {
    ...
    $.ajax({
      ...
      url: '../controlador/ACTIVOS_FIJOS/custodioC.php?listar_todo=true',
      type: 'post',
      dataType: 'json',
      /*beforeSend: function () {   
           var spiner = '<div class="text-center"><img src="../img/gif/proce.gif" width="100" height="100"></div>'     
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="row">
                        ...
                        <div class="col-sm-5 text-end"><u>
                            <p class="mb-0"><small id="lbl_sap_loc"> SAP:</small></p>
                          </u></div>
                      </div>
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <div class="row">
                        ...
                        <div class="col-sm-6 text-end"><u>
                            <p class="mb-0"><small id="lbl_sap_mar"> SAP:</small></p>
                          </u></div>
                      </div>
                    ...
                    <div class="col-sm-3">
                      <div class="row">
                        ...
                        <div class="col-sm-6 text-end"><u>
                            <p class="mb-0"><small id="lbl_sap_est"> SAP:</small></p>
                          </u></div>
                      </div>
                    ...
                    <div class="col-sm-3">
                      <div class="row">
                        ...
                        <div class="col-sm-6 text-end"><u>
                            <p class="mb-0"><small id="lbl_sap_gen"> SAP:</small></p>
                          </u></div>
                      </div>
                    ...
                    <div class="col-sm-3">
                      <div class="row">
                        ...
                        <div class="col-sm-6 text-end"><u>
                            <p class="mb-0"><small id="lbl_sap_col"> SAP:</small></p>
                          </u></div>
                      </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      <div class="row">
                        ...
                        <div class="col-sm-6 text-end"><u>
                            <p class="mb-0"><small id="lbl_sap_pro"> SAP:</small></p>
                          </u></div>
                      </div>
            ...
            <div id="pnl_farmacologia">
              ...
              if (
                ...
                <div class="row pt-3">
                  ...
                  <input type="hidden" name="txt_id_art_avaluo" id="txt_id_art_avaluo" value="<?php if (isset($_GET["id"])) {
                                                                                                echo $_GET["id"];
                                                                                              } else {
                                                                                                echo "-1";
                                                                                              } ?>">
