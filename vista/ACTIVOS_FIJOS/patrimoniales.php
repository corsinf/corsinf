...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#subir_imagen").on('click', function() {
      var id = '<?php echo $id; ?>';
      if (id == '') {
        Swal.fire('No se pudo Subir la imagen', 'Asegurese de llenar primero el detalle', 'error')
      }
...
<script type="text/javascript">
  ...
  function guardar_articulo() {
    ...
    $.ajax({
      ...
      url: '../../controlador/ACTIVOS_FIJOS/detalle_articuloC.php?guardarArticulo_patrimonial=true',
      type: 'post',
      dataType: 'json',
      success: function(response) {
        if (response > 0) {
  ...
  function guardar_info() {
    ...
    $.ajax({
      data: parametros,
      url: '../../controlador/ACTIVOS_FIJOS/detalle_articuloC.php?add_info=true',
      type: 'post',
      dataType: 'json',
      success: function(response) {
        if (response == 1) {
      ...
      <div class="card-body">
        <div class="row row-cols-auto g-1">
          <div class="col">
            ...
            <?php } else { ?>
              <a class="btn btn-outline-secondary btn-sm" href="inicio.php?mod=<?php echo $_SESSION['INICIO']['MODULO_SISTEMA']; ?>&acc=lista_patrimoniales&fil1=<?php echo $_GET['fil1'] ?>&fil2=<?php echo $_GET['fil2'] ?>"> Regresar</a>
              <div id="na">
              </div>
            <?php } ?>
          </div>
                    ...
                    <div id="panel_vista_1">
                      ...
                      <dl class="row">
                        ...
                        <dd class="col-sm-4">
                          ...
                          <span class="text-muted">/Dimensiones <br>
                            <p> <small>(largo x ancho x grosor)</small></p>
                          </span>
                        </dd>
                        <dd class="col-sm-4">
