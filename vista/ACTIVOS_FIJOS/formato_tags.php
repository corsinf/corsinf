...
<script type="text/javascript">
  $(document).ready(function() {
    var id = "<?php if (isset($_GET['forma'])) {
                echo $_GET['forma'];
              } ?>";
    if (id != '') {
      $('#txt_id').val(id);
    ...
    $("#btn_guardar").click(function() { // Con esto establecemos la acción por defecto de nuestro botón de enviar.
      if ($('#txt_nom_eti').val() != "") {
        $.post("../controlador/ACTIVOS_FIJOS/formato_tagsC.php?guardar=true", $("#form_detalles").serialize(), function(res) {
  ...
  function generar_code() {
    ...
    $.ajax({
      ...
      url: '../controlador/ACTIVOS_FIJOS/formato_tagsC.php?generar=true',
      type: 'post',
      dataType: 'json',
