      ...
      columns: [{
        ...
        },
        {
          ...
          render: function(data, type, item) {
            href = `vista/ACTIVOS_FIJOS/MARCAS/ac_marcas_detalle.php?id=${item.ID_MARCA}`;
...
<section class="content p-2">
  <div class="container-fluid">
      ...
      <div class="col-12 col-md-6 mb-3 mb-md-0">
        <div class="card-title d-flex align-items-center">
          ...
          <div class="" id="btn_nuevo">
            <a href="vista/ACTIVOS_FIJOS/MARCAS/ac_marcas_detalle.php"
    ...
    <div class="table-responsive">
      <table class="table table-striped responsive " id="tbl_marcas" style="width:100%">
        <thead>
          <tr>
            <th width="5%">ID</th>
