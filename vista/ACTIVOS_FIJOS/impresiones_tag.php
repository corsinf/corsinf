...
<script type="text/javascript">
  ...
  function g(blob) {
    ...
    $.ajax({
      ...
      url: '../controlador/ACTIVOS_FIJOS/formato_tagsC.php?guardar_camvas=true',
      type: 'post',
      dataType: 'json',
  ...
  function llenar_formatos(id = '') {
    ...
    $.ajax({
      ...
      url: '../controlador/ACTIVOS_FIJOS/formato_tagsC.php?formato=true',
      type: 'post',
      dataType: 'json',
      /*beforeSend: function () {   
  ...
  function lista_articulos() {
    ...
    $.ajax({
      ...
      url: '../controlador/ACTIVOS_FIJOS/articulosC.php?lista=true',
      type: 'POST',
      dataType: 'json',
      /*beforeSend: function () {   
           var spiner = '<div class="text-center"><img src="../img/gif/proce.gif" width="100" height="100"></div>'     
  ...
  function imprimir_tags_masivo_() {
    ...
    $.ajax({
      ...
      url: '../controlador/ACTIVOS_FIJOS/articulosC.php?lista_imprimir_=true',
      type: 'post',
      dataType: 'json',
      /*beforeSend: function () {   
           var spiner = '<div class="text-center"><img src="../img/gif/proce.gif" width="100" height="100"></div>'     
  ...
  function generar_vista() {
    ...
    if (id != "") {
      ...
      $.ajax({
        ...
        url: '../controlador/ACTIVOS_FIJOS/impresion_tagC.php?generarT=true',
        type: 'post',
        dataType: 'json',
        success: function(response) {
          console.log(response);
  ...
  function abrir_impre() {
    ...
    $.ajax({
      // data:  {parametros:parametros},
      url: '../controlador/ACTIVOS_FIJOS/impresion_tagC.php?abrir_impresora=true',
      type: 'post',
      dataType: 'json',
      success: function(response) {
  ...
  function imprimir_tags_bloque() {
    ...
    $.ajax({
      ...
      url: '../controlador/ACTIVOS_FIJOS/articulosC.php?imprimir_tags_bloque=true',
      type: 'post',
      dataType: 'json',
      success: function(response) {
        // console.log(response);  
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-sm-9">
                ...
                <button class="btn btn-outline-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#myModal_tag">
                  <li class="bx bx-purchase-tag"></li> Imprimir (N) Etiquetas
                </button>
                <button class="btn btn-outline-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#myModal_block">
                  <li class="bx bx-purchase-tag"></li> Imprimir etiquetas en bloque
                </button>
              </div>
            </div>
