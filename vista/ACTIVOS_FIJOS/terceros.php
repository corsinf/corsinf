...
<script type="text/javascript">
  ...
  function informes() {
    ...
    $.ajax({
      // data:  {id:id},
      url: '../controlador/ACTIVOS_FIJOS/reportesC.php?informes_terceros=true',
      type: 'post',
      dataType: 'json',
      /*beforeSend: function () {   
  ...
  function lista_articulos() {
    ...
    $.ajax({
      ...
      url: '../controlador/ACTIVOS_FIJOS/tercerosC.php?lista=true',
      type: 'post',
      dataType: 'json',
      beforeSend: function() {
        // var spiner = '<div class="text-center"><img src="../img/gif/proce.gif" width="100" height="100"></div>'     
      ...
      success: function(response) {
        ...
        $.each(response.datos, function(i, item) {
          ...
          if (item.TERCEROS == 1) {
            baja = 'background-color: #c6e8ff45; /*bg-blue*/'
          }
          if (item.RFID == null) {
            item.RFID = '';
          }
  ...
  function buscar_art() {
    $.ajax({
      // data:  {id:id},
      url: '../controlador/ACTIVOS_FIJOS/tercerosC.php?tipo_view=true',
      type: 'post',
      dataType: 'json',
      success: function(response) {
        if (response == 1) {
  ...
  function ver_informe_pdf(id) {
    ...
    var url = '../controlador/ACTIVOS_FIJOS/tercerosC.php?ver_pdf=true&' + filtros + '&informe=' + id + '&pag=' + $('#txt_pag').val();
    window.open(url, '_blank');
  }

  function ver_informe_excel(id) {
    var filtros = $('#pnl_filtros').serialize();
    var url = '../controlador/ACTIVOS_FIJOS/tercerosC.php?ver_excel=true&' + filtros + '&informe=' + id + '&pag=' + $('#txt_pag').val();
    window.open(url, '_blank');
  }
          ...
          <div class="ps-3">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">De Terceros</li>
              </ol>
            </nav>
          </div>
           <div class="ms-auto">
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-sm-6 col-md-8">
                <label style="background-color: #c6e8ffa8;"> Terceros </label>
              </div>
