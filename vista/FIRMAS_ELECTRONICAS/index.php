            ...
            <div class="col-xl-12 mx-auto">
                ...
                <?php if (
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 col-sm-6 col-md-4" id="pnl_pacientes" onclick="redireccionar('fir_personas');">
                        ...
                        <div class="col-6 col-sm-6 col-md-4" id="pnl_pacientes" onclick="redireccionar('fir_mis_solicitudes');">
                            <div class="card radius-10 shadow-card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div>
