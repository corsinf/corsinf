...
<script type="text/javascript">
    $(document).ready(function() {
        consultar_paralelos_tutores();
        cargar_tabla();
    });

    function cargar_tabla() {
        paralelo = $('#txt_tabla').val();
    ...
    function consultar_paralelos_tutores() {
        ...
        $.ajax({
            ...
            success: function(response) {
                $.each(response, function(i, item) {
                    ...
                    salida += '<option value="' + item.sa_par_id + '">' + item.sa_sec_nombre.toUpperCase() + ' / ' + item.sa_gra_nombre.toUpperCase() + ' / ' + item.sa_par_nombre.toUpperCase() + '</option>';
                });
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row pt-1">
                                            ...
                                            <div class="col-md-4">
                                                <label for="txt_tabla" class="form-label fw-bold">Paralelo </label>
                                                <select name="txt_tabla" id="txt_tabla" class="form-select form-select-sm" onchange="buscar_paralelo();">
