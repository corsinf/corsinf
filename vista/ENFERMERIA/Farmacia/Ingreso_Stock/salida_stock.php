	...
	function consultar_tablas_datos(valor_seleccionar) {
        ...
        // alert(sa_tbl_pac_prefijo);
         ...
         $('#sa_pac_id_comunidad').select2({
	        ...
	        language: {
                inputTooShort: function() {  return "Por favor ingresa 1 o más caracteres"; },
													...
													<div class="tab-pane fade show active" id="all" role="tabpanel">
														 ...
														 <div class="row">
					                                    	...
					                                    	<div class="col-sm-12 text-end mt-1">
					                                    		<button type="button" class="btn btn-primary btn-sm" onclick="agregar_tabla()">Ingresar</button>
					                                    	</div>
					                                    </div>
					                                    <div class="row mt-2">
					                                    	<div class="col-sm-12">                                    		
