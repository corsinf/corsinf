...
<script type="text/javascript">
    $(document).ready(function() {
        $('#tabla_administrativo').DataTable({
            ...
            responsive: true,
            ajax: {
                url: '../controlador/SALUD_INTEGRAL/docentesC.php?listar_todo=true',
                dataSrc: ''
            },
            columns: [{
                    data: 'sa_doc_cedula'
                ...
                },
                {
                    ...
                    render: function(data, type, item) {
                        ...
                        fecha_nacimiento = item.sa_doc_fecha_nacimiento;
                        //fecha_nacimiento_calc = ;
                        
                        salida = fecha_nacimiento ? calcular_edad_fecha_nacimiento(item.sa_doc_fecha_nacimiento) : '';
