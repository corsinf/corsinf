...
<script>
    ...
    function cargar_selects2_tarifas() {
        let url_unidad_tiempoC = '../controlador/HOST_TIME/CATALOGOS/hub_cats_unidad_tiempoC.php?buscar=true';
        cargar_select2_url('ddl_unidad_tiempo', url_unidad_tiempoC, '', '#modal_tarifas');
    }
</script>

<script type="text/javascript">
    function datos_tipo_espacio() {
        $('#ddl_unidad_tiempo').prop('disabled', true).trigger('change.select2');
        let id = $('#id_tipo_espacio').val();
        $.ajax({
            data: {
                id: id
            },
            ...
            success: function(response) {
                $('#ddl_unidad_tiempo').append($('<option>', {
                    ...
                    text: response[0].nombre_unidad_tiempo + " (" + response[0].prefijo + ") ",
                    selected: true
                }));
                $('#id_unidad_tiempo').val(response[0].id_unidad_tiempo);
            }
        });
    }
    ...
    function cargar_tarifa(id) {
        $.ajax({
            ...
            success: function(r) {
                ...
                $('#ddl_unidad_tiempo').val(r.id_unidad_tiempo).trigger('change');
    ...
    function guardar_tarifa() {
        var parametros = {
            ...
            'ddl_unidad': $('#id_unidad_tiempo').val(),
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response == 1) {
                    ...
                    $('#id_espacio_tarifa').val('');
                    $('#ddl_unidad_tiempo').val('').trigger('change');
...
<div class="row">
    <div class="col-12">
        <div class="card-title d-flex align-items-center justify-content-between">
            <div id="btn_nuevo">
                <button class="btn btn-success btn-sm" onclick="abrir_modal_tarifas()">
        ...
        <div class="modal-content shadow">
            ...
            <div class="modal-body">
                <form id="form_tarifas">
                    ...
                    <input type="hidden" id="id_unidad_tiempo" name="id_unidad_tiempo" value="">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12 text-end mt-4">
                            ...
                            <button type="button" class="btn btn-success btn-sm px-4" onclick="guardar_tarifa()">
    ...
    $(document).ready(function() {
        ...
        $("#form_tarifas").validate({
            ...
            messages: {
                ...
                ddl_unidad_tiempo: "Seleccione una unidad de tiempo",
            ...
            errorPlacement: function(error, element) {
                ...
                element.closest('.col-12, .col-md-6, .col-6').append(error);
            },
