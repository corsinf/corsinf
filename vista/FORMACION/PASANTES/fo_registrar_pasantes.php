...
<script type="text/javascript">
    ...
    function insertar(parametros) {
        $.ajax({
            ...
            url: '../controlador/FORMACION/fo_personasC.php?insertar=true',
            type: 'post',
            dataType: 'json',
            ...
            success: function(response) {
                if (response == 1) {
                    Swal.fire('', 'Operacion realizada con exito.', 'success').then(function() {
                        location.href = '../vista/inicio.php?mod=<?= $modulo_sistema ?>&acc=fo_pasantes';
                    });
                } else if (response == -2) {
    ...
    function eliminar(id) {
        $.ajax({
            ...
            url: '../controlador/FORMACION/fo_personasC.php?eliminar=true',
            type: 'post',
            dataType: 'json',
            success: function(response) {
                if (response == 1) {
                    ...
                    <div class="card-body p-5">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-primary">
                                <?php
                                if ($_id == '') {
                                    echo 'Registrar Pasante';
                                } else {
                                    echo 'Modificar Pasante';
                                }
                                ?>
                            </h5>
