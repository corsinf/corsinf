...
<script type="text/javascript">
    ...
    function ver_pdf(_id) {
        $('#ifr_pdf_student_consent').prop('src', '../controlador/FORMACION/fo_asistencias_pasantesC.php?pdf_asistencias=true&id=' + _id);
    }
</script>
...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">FORMACION</div>
            <?php
                            ...
                            <div class="col">
                                ...
                                <section class="content">
                                    <div class="container-fluid">
                                        ...
                                        <p>Abrir solo <a href="../controlador/FORMACION/fo_asistencias_pasantesC.php?pdf_asistencias=true&id=<?= $_id; ?>" TARGET="_BLANK">PDF</a></p>
